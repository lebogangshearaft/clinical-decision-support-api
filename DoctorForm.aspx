        ...
        <table style="width:100%;">
            ...
            <tr>
                <td class="auto-style5">
                    <table class="auto-style3">
                        <tr>
                            ...
                            <td>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="SeatchTXT" ErrorMessage="Required!" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                            </td>
                            <td>&nbsp;</td>
                        </tr>
                        <tr>
                ...
                <td class="auto-style6">
                    <asp:GridView ID="GridView1" runat="server" Height="231px" Width="532px">
                    </asp:GridView>
                </td>
            ...
            <tr>
                <td class="auto-style2">
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="DiagnosisDLB" ErrorMessage="Required!" ForeColor="#FF3300"></asp:RequiredFieldValidator>
                </td>
                <td>&nbsp;</td>
                <td>&nbsp;</td>
            </tr>
